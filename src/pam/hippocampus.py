...
if False: 
    id_ec21_ca3 = pam.addConnection(
        [ec2, ec2_1_i1, ec2_1_i2, ec2_1_i3, ec2_1_i4, ec2_1_i5, ec2_1_i6, ec2_ca3_synapse, ca3],
        ec2_neurons, ca3_neurons,
        7,
        [pam.MAP_normal, pam.MAP_top, pam.MAP_normal, pam.MAP_top, pam.MAP_euclid, pam.MAP_euclid, pam.MAP_euclid, pam.MAP_normal],
        [pam.DIS_euclid, pam.DIS_euclid, pam.DIS_euclid, pam.DIS_jumpUV, pam.DIS_jumpUV, pam.DIS_UVjump, pam.DIS_euclid, pam.DIS_euclid],
        pam.connfunc_gauss_post,
        ec2_params,
        pam.connfunc_gauss_post,
